...
function OrderInformation() {
  ...
  return(
    <>
      ...
      {orderInformation && !checkWsHasOrder && !orderInformationRequest && !orderInformationFailed && Object.keys(orderInformation).length !== 0 &&
        <OrderCard order={orderInformation} />}
      {orderInformationWs && checkWsHasOrder &&
